...
description: Técnicas y precauciones para crear, entregar y ejecutar payloads en pruebas
  de penetración dentro del marco ético del hacking certificado CEH.
eval: false
citation:
