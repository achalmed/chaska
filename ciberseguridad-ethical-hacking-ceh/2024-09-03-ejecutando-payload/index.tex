...
\title{Ejecutando payloads en ethical hacking}


\shorttitle{Ejecutando payloads en ethical hacking}
...
\hypersetup{
  pdftitle={Ejecutando payloads en ethical hacking},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Ejecutando payloads en ethical hacking}
...
\tightlist
\item
  \href{https://chaska-x.netlify.app/ciberseguridad-ethical-hacking-ceh/2024-09-03-ejecutando-payload/index.pdf}{\faIcon{file-pdf}}
  \href{https://chaska-x.netlify.app/ciberseguridad-ethical-hacking-ceh/2024-09-03-ejecutando-payload}{Ejecutando
  Payload}
\end{enumerate}
