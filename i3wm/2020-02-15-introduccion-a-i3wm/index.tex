...
\title{Introducción al gestor de ventanas i3}


\shorttitle{Introducción al gestor de ventanas i3}
...
\hypersetup{
  pdftitle={Introducci\'{o}n al gestor de ventanas i3},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Introducción al gestor de ventanas i3}
