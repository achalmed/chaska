...
\title{Integrando i3wm en tu flujo de trabajo}


\shorttitle{Integrando i3wm en tu flujo de trabajo}
...
\hypersetup{
  pdftitle={Integrando i3wm en tu flujo de trabajo},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Integrando i3wm en tu flujo de trabajo}
