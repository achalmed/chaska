...
\title{Introducción completa al sistema Linux}


\shorttitle{Introducción completa al sistema Linux}
...
\hypersetup{
  pdftitle={Introducci\'{o}n completa al sistema Linux},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Introducción completa al sistema Linux}
