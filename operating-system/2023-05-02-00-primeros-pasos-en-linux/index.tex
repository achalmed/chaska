...
\title{Primeros pasos en Linux para principiantes}


\shorttitle{Primeros pasos en Linux para principiantes}
...
\hypersetup{
  pdftitle={Primeros pasos en Linux para principiantes},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Primeros pasos en Linux para principiantes}
