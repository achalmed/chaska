...
\title{Comandos esenciales de información en Windows}


\shorttitle{Comandos esenciales de información en Windows}
...
\hypersetup{
  pdftitle={Comandos esenciales de informaci\'{o}n en Windows},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Comandos esenciales de información en Windows}
