...
\title{Instalación paso a paso de Linux}


\shorttitle{Instalación paso a paso de Linux}
...
\hypersetup{
  pdftitle={Instalaci\'{o}n paso a paso de Linux},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Instalación paso a paso de Linux}
