...
\title{Instalación de Specitify en Linux fácilmente}


\shorttitle{Instalación de Specitify en Linux fácilmente}
...
\hypersetup{
  pdftitle={Instalaci\'{o}n de Specitify en Linux f\'{a}cilmente},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Instalación de Specitify en Linux fácilmente}
...
\subsubsection{Instrucciones para la Instalación Manual de ``Stats'' en
Spicetify}\label{instrucciones-para-la-instalaciuxf3n-manual-de-stats-en-spicetify}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  \textbf{Descarga y descompresión:}

  \begin{itemize}
  \tightlist
  \item
    Descarga el archivo zip de la última versión del repositorio de
    ``Stats''.
  \item
    Descomprime el archivo descargado.
  \item
    Renombra la carpeta descomprimida a \texttt{stats}.
  \end{itemize}
\item
  \textbf{Ubicación de la carpeta:}

  \begin{itemize}
  \item
    Mueve la carpeta \texttt{stats} a la carpeta \texttt{CustomApps}
    dentro del directorio de Spicetify.
  \item
    La estructura del directorio debería ser similar a la siguiente:

\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{📦spicetify/CustomApps}
\ExtensionTok{┣}\NormalTok{ 📂marketplace}
\ExtensionTok{┣}\NormalTok{ etc...}
\ExtensionTok{┗}\NormalTok{ 📂stats}
  \ExtensionTok{┣}\NormalTok{ 📜extension.js}
  \ExtensionTok{┣}\NormalTok{ 📜index.js}
  \ExtensionTok{┣}\NormalTok{ 📜manifest.json}
  \ExtensionTok{┗}\NormalTok{ 📜style.css}
\end{Highlighting}
\end{Shaded}
  \end{itemize}
\item
  \textbf{Aplicar los cambios:}
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{spicetify}\NormalTok{ config custom\_apps stats}
\ExtensionTok{spicetify}\NormalTok{ apply}
\end{Highlighting}
\end{Shaded}
  \item
...
\item
  ...
  \tightlist
  \item
    Ahora deberías tener la aplicación ``Stats'' funcionando en
    Spicetify.
  \end{itemize}
\end{enumerate}

\subsubsection{Desinstalación de la Aplicación
``Stats''}\label{desinstalaciuxf3n-de-la-aplicaciuxf3n-stats}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  \textbf{Desinstalación básica:}
...
\end{Shaded}
  ...
  \end{itemize}
\item
  \textbf{Eliminación completa:}

  \begin{itemize}
  \tightlist
  \item
    Si deseas eliminar completamente la aplicación, elimina la carpeta
    \texttt{stats} de \texttt{CustomApps} después de ejecutar los
    comandos anteriores.
  \end{itemize}
\end{enumerate}

\subsubsection{Ayuda Adicional}\label{ayuda-adicional}

\begin{itemize}
\tightlist
\item
  Si necesitas más ayuda con la instalación, visita los
  \href{https://github.com/khanhas/spicetify-cli/wiki}{Spicetify Docs}.
\item
  Si tienes preguntas o problemas relacionados con la aplicación, abre
  un problema en el \href{https://github.com/}{repositorio de la
  aplicación}.
\item
  Si te gusta la aplicación, considera dar un like al repositorio.
\end{itemize}

\subsubsection{Resumen de Comandos}\label{resumen-de-comandos}
