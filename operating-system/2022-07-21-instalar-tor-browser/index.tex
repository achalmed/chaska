...
\title{Instalación segura de Tor Browser}


\shorttitle{Instalación segura de Tor Browser}
...
\hypersetup{
  pdftitle={Instalaci\'{o}n segura de Tor Browser},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Instalación segura de Tor Browser}
