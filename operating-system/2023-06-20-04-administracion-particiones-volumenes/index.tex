...
\title{Administración de particiones y volúmenes}


\shorttitle{Administración de particiones y volúmenes}
...
\hypersetup{
  pdftitle={Administraci\'{o}n de particiones y vol\'{u}menes},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Administración de particiones y volúmenes}
