...
\title{Enlaces duros (hard links) en Linux explicados}


\shorttitle{Enlaces duros (hard links) en Linux explicados}
...
\hypersetup{
  pdftitle={Enlaces duros (hard links) en Linux explicados},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Enlaces duros (hard links) en Linux explicados}
