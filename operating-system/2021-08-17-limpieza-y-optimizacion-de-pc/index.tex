...
\title{Limpieza y optimización de PC Windows}


\shorttitle{Limpieza y optimización de PC Windows}
...
\hypersetup{
  pdftitle={Limpieza y optimizaci\'{o}n de PC Windows},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Limpieza y optimización de PC Windows}
