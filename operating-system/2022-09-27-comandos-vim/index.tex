...
\title{Comandos esenciales de Vim para productividad}


\shorttitle{Comandos esenciales de Vim para productividad}
...
\tableofcontents
\newpage
\section[Introduction]{Comandos esenciales de Vim para productividad}
...
\item
  ...
  \item
    ...
    inserción.
  \item
    O: Insertar una nueva línea encima de la línea actual y entrar en
    modo de inserción.
  \item
