...
|---|---|--:|
| `ciberseguridad-ethical-hacking-ceh/` | sección temática | 1 |
| `i3wm/` | sección temática | 10 |
| `operating-system/` | sección temática | 21 |
...
32 entradas. Cada entrada es `<sección>/AAAA-MM-DD-slug/index.qmd` con frontmatter apaquarto y fecha ISO;
